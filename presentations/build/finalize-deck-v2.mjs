...
const result=await finalizePresentation({
 ...
 finalPath:path.join(root,'output/presentations/Remontny-Centr-concept-6-slides-v2.pptx'),
 ...
 receiptPath:path.join(root,'presentations/build/renamed.validation.json')
});
